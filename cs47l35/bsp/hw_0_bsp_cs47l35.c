...
uint32_t bsp_dut_boot()
{
    ...
    fw_img = cs47l35_dsp2_fw_img;
    fw_img_end = cs47l35_dsp2_fw_img + FW_IMG_SIZE(cs47l35_dsp2_fw_img);

    // Inform the driver that any current firmware is no longer available by passing a NULL
    // fw_info pointer to cs47l35_boot
    ret = cs47l35_boot(&cs47l35_driver, 2, NULL);
    if (ret != CS47L35_STATUS_OK)
    {
        return ret;
    }
    ...
    return cs47l35_boot(&cs47l35_driver, 2, &boot_state.fw_info);
}
...
uint32_t bsp_dut_use_case(uint32_t use_case)
{
    ...
    switch(use_case) {
        case BSP_USE_CASE_TG_HP_EN:
            ...
            cs47l35_write_reg(&cs47l35_driver, CS47L35_OUT1LMIX_INPUT_1_SOURCE, 0x4);
            cs47l35_write_reg(&cs47l35_driver, CS47L35_OUT1RMIX_INPUT_1_SOURCE, 0x4);
            cs47l35_write_reg(&cs47l35_driver, CS47L35_TONE_GENERATOR_1, CS47L35_TONE1_ENA);
        ...
        case BSP_USE_CASE_TG_HP_DIS:
            ...
            cs47l35_write_reg(&cs47l35_driver, CS47L35_TONE_GENERATOR_1, 0x0);
        ...
        case BSP_USE_CASE_OPUS_RECORD_16K_INIT:
            ...
            cs47l35_write_reg(&cs47l35_driver, CS47L35_TONE_GENERATOR_1, CS47L35_TONE1_ENA);
            cs47l35_write_reg(&cs47l35_driver, CS47L35_DSP2LMIX_INPUT_1_SOURCE, 0x4);
            ...
            buf_symbol = cs47l35_find_symbol(&cs47l35_driver, 0, CS47L35_DSP2_SYM_SILK_ENCODER_RING_BUFF_ADDRESS);
        ...
        case BSP_USE_CASE_OPUS_RECORD_DONE:
            ...
            cs47l35_write_reg(&cs47l35_driver, CS47L35_TONE_GENERATOR_1, 0);
