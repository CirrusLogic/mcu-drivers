...
#define SDK_VERSION_MINOR       (27) ///< Release Minor version
#define SDK_VERSION_UPDATE      (5) ///< Release Update version
#define SDK_GIT_SHA             ("f652df585dafe82569baf72881cebe9d978f3ffd") ///< Release Git SHA
/** @} */
