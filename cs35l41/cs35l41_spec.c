 ...
 * @file cs35l41_spec.c
 *
 * @brief Constant Arrays/Lists from CS35L41 datasheet DS1215F2
 *
 * @copyright
...
const uint8_t cs35l41_bst_k1_table[4][5] =
{
...
const uint8_t cs35l41_bst_k2_table[4][5] =
{
// C_BST values (in uF) of:
//   <20    20-50   51-100  101-200 >200
...
const uint8_t cs35l41_bst_slope_table[4] =
{
    0x75, // L_BST = 1.0 uH
    0x6B, // L_BST = 1.2 uH
    0x3B, // L_BST = 1.5 uH
...
const struct cs35l41_register_encoding cs35l41_pll_sysclk[64] = {
    { 32768,    0x00 },
    { 8000,     0x01 },
    { 11025,    0x02 },
    { 12000,    0x03 },
...
const struct cs35l41_register_encoding cs35l41_fs_rates[13] =
{
    { 12000,    0x01 },
    { 24000,    0x02 },
    { 48000,    0x03 },
...
const struct cs35l41_register_encoding cs35l41_sclk_encoding[48] =
{
    { 128000,    0x0C },
    { 176400,    0x0D },
    { 192000,    0x0E },
