 ...
 * LOCAL VARIABLES
 **********************************************************************************************************************/
cs40l26_t cs40l26_driver;
uint32_t current_halo_heartbeat = 0;
...
{
#if defined(CONFIG_FW_EXPORT_FORMAT)
    return bsp_dut_boot_export(cal_boot);
#else
    return bsp_dut_boot_fw_img_v2(cal_boot);
#endif
}
...
{
#if defined(CONFIG_FW_EXPORT_FORMAT)
    return bsp_dut_load_wavetable_export();
#else
    return bsp_dut_load_wavetable_fw_img_v2();
#endif
}
...
{
#if defined(CONFIG_FW_EXPORT_FORMAT)
    return bsp_dut_calibrate_export();
#else
    return bsp_dut_calibrate_fw_img_v2();
#endif
}
