...
ifeq ($(origin STM32CUBEH5_PATH), undefined)
$(eval STM32CUBEH5_PATH = $(REPO_PATH)/third_party/st/STM32CubeH5)
endif
STM32CUBEH5_BUILD_PATH = $(BUILD_DIR)/third_party/st/STM32CubeH5

ifeq ($(PLATFORM), cl_mcu)
    PLATFORM_MCU_SRC_PATH = $(STM32CUBEH5_PATH)
    PLATFORM_MCU_BUILD_PATH = $(STM32CUBEH5_BUILD_PATH)


    # Assign flags
    CFLAGS += -mcpu=cortex-m33 -mthumb -mfpu=fpv5-sp-d16 -mfloat-abi=hard --specs=nano.specs
    ...
    ASM_FLAGS += -mcpu=cortex-m33 -c -x assembler-with-cpp --specs=nano.specs -mfpu=fpv5-sp-d16 -mfloat-abi=hard -mthumb

    LDFLAGS += -mcpu=cortex-m33 -mthumb -mfpu=fpv5-sp-d16 -mfloat-abi=hard --specs=nosys.specs --specs=nano.specs

    # Assign sources
    PLATFORM_MCU_C_SRCS =
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Src/stm32h5xx_hal_cortex.c
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Src/stm32h5xx_hal_gpio.c
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Src/stm32h5xx_hal_i2c_ex.c
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Src/stm32h5xx_hal_i2c.c
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Src/stm32h5xx_hal_i3c.c
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Src/stm32h5xx_hal_pwr_ex.c
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Src/stm32h5xx_hal_pwr.c
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Src/stm32h5xx_hal_rcc_ex.c
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Src/stm32h5xx_hal_rcc.c
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Src/stm32h5xx_hal_tim_ex.c
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Src/stm32h5xx_hal_tim.c
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Src/stm32h5xx_hal_dma_ex.c
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Src/stm32h5xx_hal_dma.c
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Src/stm32h5xx_hal_i2s_ex.c
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Src/stm32h5xx_hal_i2s.c
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Src/stm32h5xx_hal_icache.c
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Src/stm32h5xx_hal_spi.c
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Src/stm32h5xx_hal_exti.c
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Src/stm32h5xx_hal_uart.c
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Src/stm32h5xx_hal_uart_ex.c
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Src/stm32h5xx_hal_flash.c
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Src/stm32h5xx_hal_flash_ex.c
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Src/stm32h5xx_hal.c
    PLATFORM_MCU_C_SRCS += $(STM32CUBEH5_PATH)/Drivers/CMSIS/Device/ST/STM32H5xx/Source/Templates/system_stm32h5xx.c
    ifeq ($(USE_FREERTOS), 1)
        
    endif

    PLATFORM_MCU_ASM_SRCS =
    PLATFORM_MCU_ASM_SRCS += $(REPO_PATH)/common/platform_bsp/cl_mcu/Core/Startup/startup_stm32h563iikx.s

    # Assign includes
    INCLUDES += -I$(STM32CUBEH5_PATH)/Drivers/CMSIS/Core/Include
    INCLUDES += -I$(STM32CUBEH5_PATH)/Drivers/CMSIS/Device/ST/STM32H5xx/Include
    INCLUDES += -I$(STM32CUBEH5_PATH)/Drivers/STM32H5xx_HAL_Driver/Inc
