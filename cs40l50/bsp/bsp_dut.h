 ...
 *
 * - Sets all driver data structures to 0 in cs40l50_initialize
 * - Applies optional one time config, maps IRQ GPIO and registers IRQ callback function to driver
 * in cs40l50_configure
 *
 * @return
 * - BSP_STATUS_FAIL        If an invalid cs40l50_t object is passed to cs40l50_initialize
 ...
 *
 * - This is a wrapper function for the driver's cs40l50_process, which performs event handling when
 * an IRQ is detected
 *
 * @return
 * - BSP_STATUS_FAIL        On cs40l50_process failure
 * - BSP_STATUS_OK          Otherwise
 */
 ...
 *
 * - This is a wrapper function for the driver's cs40l50_calibrate
 *
 * @return
 * - BSP_STATUS_FAIL        On cs40l50_calibrate failure
 * - BSP_STATUS_OK          Otherwise
 */
 ...
 *
 * @return
 * - BSP_STATUS_FAIL        On cs40l50_timeout_ticks_set failure
 * - BSP_STATUS_OK          Otherwise
 */
 ...
 *
 * @return uint32_t
 * - BSP_STATUS_FAIL        On failure to update cs40l50 power state
 * - BSP_STATUS_OK          Otherwise
 */
