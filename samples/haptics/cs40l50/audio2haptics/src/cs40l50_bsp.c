...
static int cs40l50_firmware_load(cs40l50_t *drv)
{
    ...
    num_blocks = cs40l50_A2H_total_coeff_blocks;
    blocks = (halo_boot_block_t *)cs40l50_A2H_coeff_blocks;
    ret = cs40l50_write_fw_blocks(i2c, blocks, num_blocks);
    if (ret != 0) {
        return ret;
    }

    LOG_INF("Loaded tuning set for A2H");
...
static int cs40l50_init(const struct device *dev)
{
    ...
    ret = cs40l50_set_asp_enable(drv, true,
